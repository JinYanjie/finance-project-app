...
public class MyHawkSpStorage implements Storage {
    private final SharedPreferences preferences;

    public MyHawkSpStorage(Context context, String tag) {
        preferences = context.getSharedPreferences(tag, Context.MODE_PRIVATE);
    }

    public MyHawkSpStorage(SharedPreferences preferences) {
        this.preferences = preferences;
    }

    @Override public <T> boolean put(String key, T value) {
        MyHawkUtils.checkNull("key", key);
